...
<h2 class="title-admin">Edit applications</h2>
<h4></h4>
...
<div class="contact-form">
    {!! Form::model($applications, ['method' => 'put', 'class' => 'form-horizontal', 'action' => ['ApplicationsController@update', $applications->id], 'files' => true]) !!}
    ...
    <div class="form-group">
      <div class="col-xl-12">
        ...
        @if($applications->upload_file != null || $applications->upload_file != '')
            <div>Old photo:</div>
            <a href="{{ url('storage/applications/'.$applications->upload_file) }}" target="_blank"><img src="{{asset('storage/applications/'.$applications->upload_file)}}" height="90px" width="auto"></a>
        @endif
      </div>
    </div>
    <div class="form-group">
