...
<h2 class="title-admin">Recommendation</h2>
...
<div class="contact-form">
    {!! Form::open(['action' => 'RecommendationsController@store', 'method' => 'post', 'class' => 'form-horizontal']) !!}
    <div class="form-group">
        <label for="title_slider" class="col-xl-12 control-label contact-contact-theme-form">Select worker:</label>
        <div class="col-xl-12">
            {!! Form::select('worker_id', $listWorker, $id_worker, ['class' => 'form-control', 'required']) !!}
        </div>
    </div>
    ...
    <div class="form-group">
      <div class="col-xl-offset-2 col-xl-12">
        ...
        {!! link_to('admin/recommendation', $title = 'Anuluj', ['class' => 'btn btn-danger']) !!}
      </div>
    </div>
  {!! Form::close() !!}
</div>
